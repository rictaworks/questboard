...
- Backend env: `X_OAUTH_CLIENT_ID`, `X_OAUTH_REDIRECT_URI`, `RECAPTCHA_SECRET_KEY`, `X_FOLLOWER_GATE_BASE_URL`, `X_FOLLOWER_GATE_CLIENT_ID`, `X_FOLLOWER_GATE_CREDENTIAL`, `ADMIN_BASIC_AUTH_USERNAME`, `ADMIN_BASIC_AUTH_PASSWORD`, `CORS_ALLOWED_ORIGINS`, `SYNC_SERVER_REDIS_URL`, `SYNC_SERVER_REDIS_CHANNEL_PREFIX`, `SYNC_SERVER_REDIS_POOL_SIZE`, `SENTRY_DSN`
