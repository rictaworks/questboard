...
test('resolveCanvasIntent returns the expected intent for key F1 scenarios', () => {
  ...
  const cases = [
    ...
    // テキスト・付箋はオブジェクト本体のダブルクリックでもインライン編集に入る（issue #199）
    [{kind: 'pointer', phase: 'dblclick', device: 'mouse', buttons: 1, touchCount: 1, movementX: 0, movementY: 0, elapsedTimeMs: 0, hitTarget: {kind: 'object', objectId: 'node-1', textEditable: true}, modifiers: modifiers(), selection: selected}, {kind: 'edit-text'}],
    [{kind: 'pointer', phase: 'dblclick', device: 'mouse', buttons: 1, touchCount: 1, movementX: 0, movementY: 0, elapsedTimeMs: 0, hitTarget: object, modifiers: modifiers(), selection: selected}, {kind: 'ignore'}],
